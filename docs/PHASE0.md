...
| Local 16GB train no-go; rental L40S smoke **go** + revision pinned | T8 done |
| Privileged-teacher POV audit + assistant-mask proof | T9 done |
| Tier A feature-aware templates landed (ticket 10); Phase 1 scale unblocked | Phase 1 ready |
